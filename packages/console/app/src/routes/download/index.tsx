      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://cyxcode.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>cyxcode.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g cyxcode")}>
                <code>
                  npm i -g <strong>cyxcode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g cyxcode")}>
                <code>
                  bun add -g <strong>cyxcode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install code3hr/tap/cyxcode")}>
                <code>
                  brew install <strong>code3hr/tap/cyxcode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S cyxcode")}>
                <code>
                  paru -S <strong>cyxcode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask cyxcode-desktop")}>
                <code>
                  brew install --cask <strong>cyxcode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
