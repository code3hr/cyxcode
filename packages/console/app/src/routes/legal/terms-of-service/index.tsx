          ...
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://cyxcode.ai/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <p>
                ...
                our site located at cyxcode.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                ...
                click here{" "}
                <a href="https://cyxcode.ai/legal/privacy-policy">https://cyxcode.ai/legal/privacy-policy</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://cyxcode.ai/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://cyxcode.ai/auth">https://cyxcode.ai/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://cyxcode.ai/legal/privacy-policy</a>, as well
