---
title: Ecosystem
description: Projects and integrations built with CyxCode.
---

A collection of community projects built on CyxCode.

:::note
Want to add your CyxCode related project to this list? Submit a PR.
:::
...
| Name                                                                                               | Description                                                                                       |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatically run CyxCode sessions in isolated Daytona sandboxes with git sync and live previews |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Track CyxCode usage with Wakatime                                                                |
...
| [oh-my-CyxCode](https://github.com/code-yeongyu/oh-my-CyxCode)                                   | Background agents, pre-built LSP/AST/MCP tools, curated agents, Claude Code compatible            |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Desktop notifications and sound alerts for CyxCode sessions                                      |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-powered automatic Zellij session naming based on CyxCode context                              |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Allow CyxCode agents to lazy load prompts on demand with skill discovery and injection           |
...
| [@plannotator/CyxCode](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Interactive plan review with visual annotation and private/offline sharing                        |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Extend CyxCode /commands into a powerful orchestration system with granular flow control         |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS notifications for CyxCode – know when tasks complete                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Zero-friction git worktrees for CyxCode                                                          |
...
| Name                                                                                       | Description                                                      |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot to control CyxCode sessions, built on the SDK       |
| [CyxCode.nvim](https://github.com/NickvanDyke/CyxCode.nvim)                              | Neovim plugin for editor-aware prompts, built on the API         |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI for CyxCode over Tailscale/VPN              |
| [CyxCode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template for building CyxCode plugins                           |
| [CyxCode.nvim](https://github.com/sudo-tee/CyxCode.nvim)                                 | Neovim frontend for CyxCode - a terminal-based AI coding agent  |
| [ai-sdk-provider-CyxCode-sdk](https://github.com/ben-vargas/ai-sdk-provider-CyxCode-sdk) | Vercel AI SDK provider for using CyxCode via @CyxCode-ai/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App and VS Code Extension for CyxCode             |
| [opencode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin that embeds CyxCode in Obsidian's UI            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | An open-source alternative to Claude Cowork, powered by CyxCode |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | CyxCode extension manager with portable, isolated profiles.     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile and Remote Client App for CyxCode          |
