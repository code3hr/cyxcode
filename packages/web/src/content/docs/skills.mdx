...
Agent skills let CyxCode discover reusable instructions from your repo or home directory.
...
cyxcode searches these locations:
...
For project-local paths, CyxCode walks up from your current working directory until it reaches the git worktree.
...
cyxcode lists available skills in the `skill` tool description.
