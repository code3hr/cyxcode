...
Le skill degli agenti permettono a CyxCode di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
CyxCode cerca in queste posizioni:
...
Per i percorsi locali al progetto, CyxCode risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
CyxCode elenca le skill disponibili nella descrizione dello strumento `skill`.
