...
cyxcode supporta anche la lettura del file `AGENTS.md` da piu' posizioni, e questo serve a scopi diversi.
...
Per gli utenti che migrano da Claude Code, CyxCode supporta come fallback le convenzioni di file di Claude Code:
