---
title: Zen
description: Lista curata di modelli fornita da CyxCode.
---
...
CyxCode Zen è una lista di modelli testati e verificati dal team di CyxCode.

:::note
CyxCode Zen è attualmente in beta.
:::

Zen funziona come qualunque altro provider in CyxCode. Accedi a CyxCode Zen e ottieni la tua chiave API. È **completamente opzionale** e non devi usarlo per usare CyxCode.
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con CyxCode.
:::
...
CyxCode Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

CyxCode Zen funziona come qualunque altro provider in CyxCode.

1. Accedi a **<a href={console}>CyxCode Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona CyxCode Zen e incolla la chiave API.
...
| GPT 5.4 Pro           | gpt-5.4-pro           | `https://cyxcode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.4 Mini          | gpt-5.4-mini          | `https://cyxcode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.4 Nano          | gpt-5.4-nano          | `https://cyxcode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.3 Codex         | gpt-5.3-codex         | `https://cyxcode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.3 Codex Spark   | gpt-5.3-codex-spark   | `https://cyxcode.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
...
| MiMo V2 Flash Free    | mimo-v2-flash-free    | `https://cyxcode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Nemotron 3 Super Free | nemotron-3-super-free | `https://cyxcode.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

Il [model id](/docs/config/#models) nella config di CyxCode usa il formato `opencode/<model-id>`. Per esempio, per GPT 5.3 Codex, useresti `opencode/gpt-5.3-codex` nella config.
...
- MiniMax M2.5 Free è disponibile su CyxCode per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- MiMo V2 Flash Free è disponibile su CyxCode per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Super Free è disponibile su CyxCode per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth gratuito su CyxCode per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato CyxCode Zen per:
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con CyxCode.
