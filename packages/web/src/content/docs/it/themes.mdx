...
Con CyxCode puoi scegliere tra diversi temi integrati, usare un tema che si adatta al tema del tuo terminale oppure definire un tema personalizzato.

Per impostazione predefinita, CyxCode usa il tema `opencode`.
...
CyxCode include diversi temi integrati.
...
- Vuole che CyxCode corrisponda all'aspetto del terminale
...
CyxCode supporta un sistema di temi flessibile basato su JSON che permette di creare e personalizzare temi facilmente.
