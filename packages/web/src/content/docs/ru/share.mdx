---
title: Share
description: Share your CyxCode conversations.
---

CyxCode's share feature allows you to create public links to your CyxCode conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, CyxCode:
...
CyxCode supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, CyxCode uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
[Learn more](/docs/enterprise) about using CyxCode in your organization.
