...
cyxcode, VS Code, Cursor veya bir terminali destekleyen herhangi bir IDE ile entegre olur. Başlamak için terminalde `opencode` komutunu çalıştırmanız yeterli.
...
cyxcode'u VS Code'a ve Cursor, Windsurf, VSCodium gibi popüler çatallara yüklemek için:
