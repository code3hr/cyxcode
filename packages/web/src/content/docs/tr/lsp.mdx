...
description: CyxCode, LSP sunucularınızla bütünleşir.
---

CyxCode, LLM'in kod tabanınızla etkileşime girmesine yardımcı olmak için Dil Sunucusu Protokolünüzle (LSP) bütünleşir. LLM'ye geri bildirim sağlamak için tanılamayı kullanır.

---

## Yerleşik

CyxCode, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
