...
cyxcode, **75+ LLM sağlayıcısını** desteklemek için [AI SDK](https://ai-sdk.dev/) ve [Models.dev](https://models.dev) kullanır ve yerel modellerin çalıştırılmasını destekler.
...
Burada tam kimlik `provider_id/model_id`'dir. Örneğin, [CyxCode Zen](/docs/zen) kullanıyorsanız, GPT 5.1 Codex için `opencode/gpt-5.1-codex` kullanırsınız.
...
cyxcode birçok sağlayıcı için varsayılan değişkenlerle birlikte gelir:
...
cyxcode başlatıldığında modelleri aşağıdaki öncelik sırasına göre kontrol eder:
