---
title: ACP Desteği
description: CyxCode'u ACP uyumlu herhangi bir editörde kullanın.
---

cyxcode, [Agent Client Protocol](https://agentclientprotocol.com) veya (ACP) dosyalarını destekleyerek onu doğrudan uyumlu editörlerde ve IDE'lerde kullanmanızı sağlar.
...
cyxcode'u ACP aracılığıyla kullanmak için düzenleyicinizi `cyxcode acp` komutunu çalıştıracak şekilde yapılandırın.
...
Açmak için AI Chat agent seçicisindeki yeni 'CyxCode' ajanını kullanın.
...
cyxcode'u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)'de ACP ajanı olarak kullanmak için Neovim yapılandırmanıza aşağıdakileri ekleyin:
...
cyxcode, terminalde olduğu gibi ACP aracılığıyla aynı şekilde çalışır. Tüm özellikler desteklenir:
