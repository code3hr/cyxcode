---
title: SDK
description: CyxCode sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

cyxcode JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
cyxcode'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
