...
cyxcode'daki modlar, farklı kullanım durumları için davranışı, araçları ve istemleri özelleştirmenize olanak tanır.
...
cyxcode iki yerleşik modla birlikte gelir.
