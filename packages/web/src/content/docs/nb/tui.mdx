---
title: TUI
description: Using the CyxCode terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CyxCode provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running CyxCode starts the TUI for the current directory.
...
When using the CyxCode TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to CyxCode. Allows you to select from available providers and add their API keys.
