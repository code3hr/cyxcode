---
title: Compartir
description: Comparte tus conversaciones CyxCode.
---

La función para compartir de CyxCode te permite crear enlaces públicos a tus conversaciones de CyxCode, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, CyxCode:
...
CyxCode admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, CyxCode usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
