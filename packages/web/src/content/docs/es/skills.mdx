...
Las habilidades del agente permiten a CyxCode descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
CyxCode busca estas ubicaciones:
...
Para las rutas locales del proyecto, CyxCode sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
CyxCode enumera las habilidades disponibles en la descripción de la herramienta `skill`.
