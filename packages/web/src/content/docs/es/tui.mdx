---
title: TUI
description: Usando la interfaz de usuario del terminal CyxCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CyxCode proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar CyxCode se inicia TUI para el directorio actual.
...
Cuando utilice CyxCode TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a CyxCode. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de CyxCode. _Alias_: `/quit`, `/q`
