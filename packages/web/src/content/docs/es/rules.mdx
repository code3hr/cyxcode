...
cyxcode también admite la lectura del archivo `AGENTS.md` desde múltiples ubicaciones. Y esto tiene diferentes propósitos.
...
Para los usuarios que migran desde Claude Code, CyxCode admite las convenciones de archivos de Claude Code como alternativas:
