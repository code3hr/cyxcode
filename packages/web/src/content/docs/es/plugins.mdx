---
title: Complementos
description: Escriba sus propios complementos para extender CyxCode.
---

Los complementos le permiten extender CyxCode al conectarse a varios eventos y personalizar el comportamiento. Puede crear complementos para agregar nuevas funciones, integrarlos con servicios externos o modificar el comportamiento predeterminado de CyxCode.
...
CyxCode ejecuta `bun install` al inicio para instalarlos. Luego, sus complementos y herramientas pueden importarlos.
...
:::note
Si está utilizando la aplicación de escritorio CyxCode, puede enviar notificaciones del sistema automáticamente cuando una respuesta esté lista o cuando se produzca un error en una sesión.
:::
...
Niveles: `debug`, `info`, `warn`, `error`. Consulte la [documentación del SDK](https://cyxcode.ai/docs/sdk) para obtener más detalles.
