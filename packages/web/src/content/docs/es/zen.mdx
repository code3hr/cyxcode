---
title: Zen
description: Lista seleccionada de modelos proporcionada por CyxCode.
---
...
CyxCode Zen es una lista de modelos probados y verificados proporcionada por el equipo CyxCode.

:::note
CyxCode Zen se encuentra actualmente en versión beta.
:::

Zen funciona como cualquier otro proveedor en CyxCode. Inicias sesion en CyxCode Zen y obtienes
tu API key. Es **completamente opcional** y no necesitas usarlo para usar CyxCode.
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con CyxCode.
:::
...
CyxCode Zen es una puerta de enlace de IA que le brinda acceso a estos modelos.

---

## Cómo funciona

CyxCode Zen funciona como cualquier otro proveedor en CyxCode.

1. Inicias sesión en **<a href={console}>CyxCode Zen</a>**, agregas tu facturación
   detalles y copie su clave API.
2. Ejecuta el comando `/connect` en TUI, selecciona CyxCode Zen y pega tu clave API.
...
El [model ID](/docs/config/#models) en tu configuracion de CyxCode
...
- MiniMax M2.5 Free está disponible en CyxCode por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo sigiloso gratuito en CyxCode por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. **No tener ningún bloqueo** al permitirle usarlo con cualquier otro agente de codificación. Y siempre le permitirá utilizar cualquier otro proveedor con CyxCode también.
