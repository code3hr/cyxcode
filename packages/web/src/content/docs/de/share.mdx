---
title: Teilen
description: Teile CyxCode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu CyxCode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht CyxCode Folgendes:
...
CyxCode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt CyxCode den manuellen Modus.
