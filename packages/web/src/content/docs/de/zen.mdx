---
title: Zen
description: Kuratierte Modellliste direkt von CyxCode.
---
...
CyxCode Zen ist eine vom CyxCode-Team getestete und verifizierte Modellliste.

:::note
CyxCode Zen befindet sich aktuell in der Beta.
:::

Zen funktioniert wie jeder andere Provider in CyxCode.
Du meldest dich bei CyxCode Zen an, holst dir deinen API-Key und nutzt ihn optional.
...
:::tip
Wir haben eine Auswahl aus Modellen und Providern getestet, die gut mit CyxCode funktionieren.
:::
...
CyxCode Zen ist ein AI-Gateway, das dir Zugriff auf genau diese Modelle gibt.

---

## Funktionsweise

CyxCode Zen funktioniert wie jeder andere Provider in CyxCode.

1. Melde dich bei **<a href={console}>CyxCode Zen</a>** an, hinterlege Zahlungsdaten und kopiere deinen API-Key.
2. Fuehre in der TUI `/connect` aus, waehle CyxCode Zen und fuege den API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner CyxCode-Konfiguration hat das Format `opencode/<model-id>`.
...
- MiniMax M2.5 Free ist fuer begrenzte Zeit auf CyxCode verfuegbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das fuer begrenzte Zeit kostenlos auf CyxCode verfuegbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben CyxCode Zen entwickelt, um:
...
4. **Kein Lock-in** zu erzwingen, damit du Zen mit anderen Coding-Agents und CyxCode weiter mit anderen Providern nutzen kannst
