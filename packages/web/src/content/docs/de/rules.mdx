...
cyxcode kann `AGENTS.md` aus mehreren Orten lesen.
...
Wenn du von Claude Code kommst, unterstuetzt CyxCode dessen Dateikonventionen als Fallback:
...
cyxcode parst Datei-Referenzen in `AGENTS.md` nicht automatisch.
