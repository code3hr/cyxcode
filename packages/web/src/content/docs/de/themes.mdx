...
Mit CyxCode kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet CyxCode das `opencode`-Theme.
...
CyxCode liefert mehrere eingebaute Themes mit.
...
- CyxCode optisch ans Terminal anpassen wollen
...
CyxCode unterstuetzt ein flexibles JSON-basiertes Theme-System.
