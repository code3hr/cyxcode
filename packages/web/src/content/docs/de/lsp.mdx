---
title: LSP Server
description: CyxCode lässt sich in Ihren LSP-Server integrieren.
---

CyxCode lässt sich in Ihr Language Server Protocol (LSP) integrieren, um die Interaktion von LLM mit Ihrer Codebasis zu unterstützen. Es verwendet Diagnosefunktionen, um dem LLM Feedback zu geben.

---

## Integriert

CyxCode verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn CyxCode eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer CyxCode-Konfiguration anpassen.
