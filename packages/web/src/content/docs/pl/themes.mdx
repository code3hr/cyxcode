...
cyxcode ma kilka wbudowanych motywów.
...
- Chcą, aby CyxCode pasował do wyglądu ich terminala
...
cyxcode obsługuje elastyczny system motywów oparty na JSON, który pozwala użytkownikom łatwo tworzyć i dostosowywać motywy.
