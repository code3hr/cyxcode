...
cyxcode integruje się z przepływem pracy GitLab poprzez potok GitLab CI/CD lub z GitLab Duo.
...
cyxcode działa w zwykłym potoku GitLab. Możesz wbudować go w potok jako [komponent CI](https://docs.gitlab.com/ee/ci/components/)
...
cyxcode integruje się z przepływem pracy GitLab.
...
cyxcode działa w potoku CI/CD GitLab. Oto, czego potrzebujesz, aby przejść do:
