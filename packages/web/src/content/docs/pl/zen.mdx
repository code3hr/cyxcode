---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez CyxCode.
---
...
CyxCode Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół CyxCode.

:::note
CyxCode Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w CyxCode. Logujesz się do CyxCode Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z CyxCode.
:::
...
CyxCode Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

CyxCode Zen działa jak każdy inny dostawca w CyxCode.

1. Logujesz się do **<a href={console}>CyxCode Zen</a>**, dodajesz dane rozliczeniowe
   i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz CyxCode Zen i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji CyxCode
...
- MiniMax M2.5 Free jest dostępny w CyxCode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w CyxCode przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
4. Nie **mieć blokady** (no lock-in), umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalać na korzystanie z dowolnego innego dostawcy w CyxCode.
