...
cyxcode używa [AI SDK](https://ai-sdk.dev/) i [Models.dev](https://models.dev) do obsługi **ponad 75 dostawców LLM** i obsługi uruchamiania modeli pierwszych.
...
Tutaj pełny identyfikator do `provider_id/model_id`. Na przykład, użycie [CyxCode Zen](/docs/zen), przestrzeganie `opencode/gpt-5.1-codex` dla Kodeksu GPT 5.1.
...
cyxcode jest dostarczany z domyślnymi wariantami dla wielu dostawców:
