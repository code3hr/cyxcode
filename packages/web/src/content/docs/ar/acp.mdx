---
title: دعم ACP
description: استخدم CyxCode في أي محرر متوافق مع ACP.
---

يدعم CyxCode بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام CyxCode عبر ACP، اضبط محررك ليشغّل الأمر `cyxcode acp`.

يشغّل هذا الأمر CyxCode كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'CyxCode' من محدد الوكلاء في AI Chat.
...
لاستخدام CyxCode كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام CyxCode كوكيل ACP للدردشة.
...
يعمل CyxCode عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات CyxCode
