---
title: خوادم LSP
description: يتكامل CyxCode مع خوادم LSP لديك.
---

يتكامل CyxCode مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي CyxCode مع عدة خوادم LSP مدمجة للغات الشائعة:
