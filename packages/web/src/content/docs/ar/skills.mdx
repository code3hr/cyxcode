...
تتيح مهارات الوكيل لـ CyxCode اكتشاف تعليمات قابلة لإعادة الاستخدام من مستودعك أو من دليل المنزل.
...
بالنسبة لمسارات المشروع المحلية، يتدرج CyxCode صعوداً من دليل العمل الحالي حتى يصل إلى `git worktree`.
...
يعرض CyxCode المهارات المتاحة في وصف أداة `skill`.
