...
مع CyxCode يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم CyxCode سمتنا `opencode`.
...
يأتي CyxCode مع عدة سمات مدمجة.
...
- يريدون أن يطابق CyxCode مظهر terminal لديهم
...
يدعم CyxCode نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
