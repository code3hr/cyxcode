---
title: 플러그인
description: CyxCode를 확장하기 위해 자신만의 플러그인을 작성하세요.
---
...
:::note
cyxcode 데스크톱 앱을 사용하는 경우 응답이 준비되어 있거나 세션 오류가 있을 때 시스템 알림을 자동으로 보낼 수 있습니다.
:::
...
레벨: `debug`, `info`, `warn`, `error`. [SDK 문서](https://cyxcode.ai/docs/sdk)를 참고하세요.
