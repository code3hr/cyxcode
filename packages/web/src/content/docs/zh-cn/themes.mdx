...
With CyxCode you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, CyxCode uses our own `cyxcode` theme.
...
CyxCode comes with several built-in themes.
...
- Want CyxCode to match their terminal's appearance
...
CyxCode supports a flexible JSON-based theme system that allows users to create and customize themes easily.
