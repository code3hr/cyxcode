---
title: Custom Tools
description: Create tools the LLM can call in CyxCode.
---

Custom tools are functions you create that the LLM can call during conversations. They work alongside CyxCode's [built-in tools](/docs/tools) like `read`, `write`, and `bash`.
