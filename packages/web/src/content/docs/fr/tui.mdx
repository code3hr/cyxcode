---
title: TUI
description: Utilisation de l’interface utilisateur du terminal CyxCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CyxCode fournit une interface de terminal interactif ou TUI pour travailler sur vos projets avec un LLM.

L’exécution de CyxCode démarre le TUI pour le répertoire actuel.
...
Lorsque vous utilisez le CyxCode TUI, vous pouvez taper `/` suivi d'un nom de commande pour exécuter rapidement des actions. Par exemple:
...
Ajoutez un fournisseur à CyxCode. Vous permet de sélectionner parmi les fournisseurs disponibles et d’ajouter leurs clés API.
