---
title: Serveurs LSP
description: CyxCode s'intègre à vos serveurs LSP.
---

CyxCode s'intègre via le protocole LSP (Language Server Protocol) pour aider le LLM à interagir avec votre base de code. Il utilise des diagnostics pour fournir des commentaires au LLM.

---

## Serveurs intégrés

CyxCode est livré avec plusieurs serveurs LSP intégrés pour les langages populaires :
