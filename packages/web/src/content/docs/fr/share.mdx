---
title: Partager
description: Partagez vos conversations CyxCode.
---

La fonctionnalité de partage de CyxCode vous permet de créer des liens publics vers vos conversations CyxCode, afin que vous puissiez collaborer avec vos coéquipiers ou obtenir de l'aide d'autres personnes.
...
Lorsque vous partagez une conversation, CyxCode :
...
CyxCode prend en charge trois modes de partage qui contrôlent la manière dont les conversations sont partagées :

---

### Manuel (par défaut)

Par défaut, CyxCode utilise le mode de partage manuel. Les sessions ne sont pas partagées automatiquement, mais vous pouvez les partager manuellement à l'aide de la commande `/share` :
