...
cyxcode prend également en charge la lecture du fichier `AGENTS.md` à partir de plusieurs emplacements. Et cela répond à des objectifs différents.
...
Pour les utilisateurs migrant depuis Claude Code, CyxCode prend en charge les conventions de fichiers de Claude Code comme solutions de secours :
