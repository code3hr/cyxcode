...
Les compétences d'agent permettent à CyxCode de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
CyxCode recherche ces emplacements :
...
Pour les chemins locaux du projet, CyxCode remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
CyxCode répertorie les compétences disponibles dans la description de l'outil `skill`.
