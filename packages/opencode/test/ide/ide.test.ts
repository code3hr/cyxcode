...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CYXCODE_CALLER", () => {
    process.env["CYXCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CYXCODE_CALLER", () => {
    process.env["CYXCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CYXCODE_CALLER", () => {
    process.env["CYXCODE_CALLER"] = "unknown"
