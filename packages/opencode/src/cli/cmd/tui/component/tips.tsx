...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at cyxcode.ai",
  ...
  "CyxCode auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "CyxCode auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "CyxCode uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent CyxCode from reading sensitive files",
  "Use {highlight}cyxcode run{/highlight} for non-interactive scripting",
  "Use {highlight}cyxcode --continue{/highlight} to resume the last session",
  "Use {highlight}cyxcode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}cyxcode serve{/highlight} for headless API access to CyxCode",
  "Use {highlight}cyxcode run --attach{/highlight} to connect to a running server",
  "Run {highlight}cyxcode upgrade{/highlight} to update to the latest version",
  "Run {highlight}cyxcode auth list{/highlight} to see all configured providers",
  "Run {highlight}cyxcode agent create{/highlight} for guided agent creation",
  "Use {highlight}/cyxcode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}cyxcode github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/cyxcode fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}cyxcode debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/code3hr/cyxcode{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with CyxCode Zen for curated, tested models",
