...
import { Module } from "@cyxcode/util/module"
...
export namespace LSPServer {
    ...
    async spawn(root) {
      ...
      if (!binary) {
        ...
        if (!(await Filesystem.exists(js))) {
          if (Flag.CYXCODE_DISABLE_LSP_DOWNLOAD) return
  ...
  export const ESLint: Info = {
    ...
    async spawn(root) {
      ...
      if (!(await Filesystem.exists(serverPath))) {
        ...
        const response = await Http.fetch("https://github.com/microsoft/vscode-eslint/archive/refs/heads/main.zip")
  ...
  export const Ty: Info = {
    ...
    async spawn(root) {
      if (!Flag.CYXCODE_EXPERIMENTAL_LSP_TY) {
        return undefined
      }
    ...
    async spawn(root) {
      ...
      if (!binary) {
        ...
        if (!(await Filesystem.exists(binary))) {
          ...
          const response = await Http.fetch("https://github.com/elixir-lsp/elixir-ls/archive/refs/heads/master.zip")
          if (!response.ok) return
  ...
  export const Zls: Info = {
    ...
    async spawn(root) {
      ...
      if (!bin) {
        ...
        const releaseResponse = await Http.fetch("https://api.github.com/repos/zigtools/zls/releases/latest")
        ...
        const downloadResponse = await Http.fetch(downloadUrl)
  ...
  export const Clangd: Info = {
    ...
    async spawn(root) {
      ...
      const releaseResponse = await Http.fetch("https://api.github.com/repos/clangd/clangd/releases/latest")
      if (!releaseResponse.ok) {
      ...
      const downloadResponse = await Http.fetch(asset.browser_download_url)
      if (!downloadResponse.ok) {
  ...
  export const JDTLS: Info = {
    ...
    async spawn(root) {
      ...
      if (!installed) {
        ...
        const download = await Http.fetch(releaseURL)
  ...
  export const KotlinLS: Info = {
    ...
    async spawn(root) {
      ...
      if (!installed) {
        ...
        const releaseResponse = await Http.fetch("https://api.github.com/repos/Kotlin/kotlin-lsp/releases/latest")
        if (!releaseResponse.ok) {
  ...
  export const LuaLS: Info = {
    ...
    async spawn(root) {
      ...
      if (!bin) {
        ...
        const releaseResponse = await Http.fetch("https://api.github.com/repos/LuaLS/lua-language-server/releases/latest")
        if (!releaseResponse.ok) {
  ...
  export const TerraformLS: Info = {
    ...
    async spawn(root) {
      ...
      if (!bin) {
        ...
        const releaseResponse = await Http.fetch("https://api.releases.hashicorp.com/v1/releases/terraform-ls/latest")
        if (!releaseResponse.ok) {
        ...
        const downloadResponse = await Http.fetch(build.url)
        if (!downloadResponse.ok) {
  ...
  export const TexLab: Info = {
    ...
    async spawn(root) {
      ...
      if (!bin) {
        ...
        const response = await Http.fetch("https://api.github.com/repos/latex-lsp/texlab/releases/latest")
        if (!response.ok) {
  ...
  export const Tinymist: Info = {
    ...
    async spawn(root) {
      ...
      if (!bin) {
        ...
        const response = await Http.fetch("https://api.github.com/repos/Myriad-Dreamin/tinymist/releases/latest")
        if (!response.ok) {
