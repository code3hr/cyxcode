    ...
    return app
      ...
      .use(
        cors({
          origin(input) {
            ...
            // *.cyxcode.ai (https only, adjust if needed)
      ...
      .post(
        ...
        describeRoute({
          ...
          description: "Clean up and dispose the current CyxCode instance, releasing all resources.",
      ...
      .get(
        ...
        describeRoute({
          summary: "Get paths",
          description: "Retrieve the current working directory and related path information for the CyxCode instance.",
      ...
      .get(
        ...
        describeRoute({
          ...
          description: "Get a list of all available commands in the CyxCode system.",
      ...
      .get(
        ...
        describeRoute({
          summary: "List agents",
          description: "Get a list of all available AI agents in the CyxCode system.",
      ...
      .get(
        ...
        describeRoute({
          summary: "List skills",
          description: "Get a list of all available skills in the CyxCode system.",
