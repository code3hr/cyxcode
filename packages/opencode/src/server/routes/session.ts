  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all CyxCode sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific CyxCode session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new CyxCode session for interacting with AI assistants and managing conversations.",
