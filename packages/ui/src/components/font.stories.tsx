...
const docs = `### Overview
Loads CyxCode typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>CyxCode Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>CyxCode Mono Sample</div>
    </div>
  ),
}
