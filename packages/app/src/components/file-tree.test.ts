...
beforeAll(async () => {
  ...
  mock.module("@cyxcode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@cyxcode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@cyxcode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@cyxcode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
