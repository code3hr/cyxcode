import type { ProviderAuthAuthorization } from "@cyxcode/sdk/v2/client"
...
import { List, type ListRef } from "@cyxcode/ui/list"
...
export function DialogConnectProvider(props: { provider: string }) {
  ...
  const [store, setStore] = createStore({
    ...
    inputs: undefined as undefined | Record<string, string>,
    ...
    async function handleSubmit(e: SubmitEvent) {
      ...
      await globalSDK.client.auth.set({
        ...
        auth: {
          type: "api",
          key: apiKey,
          ...(store.inputs ? { metadata: store.inputs } : {}),
        },
      })
      await complete()
    }
          ...
          <Match when={provider().id === "opencode"}>
            <div class="flex flex-col gap-4">
              ...
              <div class="text-14-regular text-text-base">
                ...
                <Link href="https://cyxcode.ai/zen" tabIndex={-1}>
