export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by CyxCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in CyxCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in CyxCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in CyxCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in CyxCode.json",
  ...
  "dialog.server.description": "Switch which CyxCode server this app connects to.",
  ...
  "toast.update.description": "A new version of CyxCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the CyxCode team",
  ...
  "error.chain.checkConfig": "Check your config (CyxCode.json) provider/model names",
  ...
  "sidebar.gettingStarted.line1": "CyxCode includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for CyxCode",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how CyxCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether CyxCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how CyxCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when CyxCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of CyxCode.",
