export const dict = {
  ...
  "dialog.provider.CyxCode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.CyxCode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.CyxCodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje CyxCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u CyxCode-u.",
  ...
  "provider.connect.CyxCodeZen.line1":
    "CyxCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.CyxCodeZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.CyxCodeZen.visit.prefix": "Posjeti ",
  "provider.connect.CyxCodeZen.visit.link": "cyxcode.ai/zen",
  "provider.connect.CyxCodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u CyxCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u CyxCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u CyxCode.json",
  ...
  "dialog.server.description": "Promijeni na koji se CyxCode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija CyxCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku CyxCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (CyxCode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: CyxCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "CyxCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni CyxCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u CyxCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako CyxCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li CyxCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu CyxCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se CyxCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju CyxCode-a.",
