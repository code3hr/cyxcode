export const dict = {
  ...
  "dialog.provider.CyxCode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.CyxCode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.CyxCodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez CyxCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w CyxCode.",
  ...
  "provider.connect.CyxCodeZen.line1":
    "CyxCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.CyxCodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.CyxCodeZen.visit.link": "cyxcode.ai/zen",
  "provider.connect.CyxCodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w CyxCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w CyxCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w CyxCode.json",
  ...
  "dialog.server.description": "Przełącz serwer CyxCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja CyxCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu CyxCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (CyxCode.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, CyxCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "CyxCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the CyxCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla CyxCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd CyxCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy CyxCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw CyxCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania CyxCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji CyxCode.",
