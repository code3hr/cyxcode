export const dict = {
  ...
  "dialog.provider.CyxCode.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.CyxCode.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.CyxCodeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af CyxCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i CyxCode.",
  ...
  "provider.connect.CyxCodeZen.line1":
    "CyxCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.CyxCodeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.CyxCodeZen.visit.prefix": "Besøg ",
  "provider.connect.CyxCodeZen.visit.link": "cyxcode.ai/zen",
  "provider.connect.CyxCodeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i CyxCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i CyxCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i CyxCode.json",
  ...
  "dialog.server.description": "Skift hvilken CyxCode-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af CyxCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til CyxCode-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (CyxCode.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, CyxCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "CyxCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør CyxCode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for CyxCode",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan CyxCode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om CyxCode følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan CyxCode er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når CyxCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af CyxCode.",
