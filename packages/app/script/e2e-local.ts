...
const keepSandbox = process.env.CYXCODE_E2E_KEEP_SANDBOX === "1"

const serverEnv = {
  ...process.env,
  CYXCODE_DISABLE_SHARE: process.env.CYXCODE_DISABLE_SHARE ?? "true",
  CYXCODE_DISABLE_LSP_DOWNLOAD: "true",
  CYXCODE_DISABLE_MODELS_FETCH: "true",
  CYXCODE_DISABLE_DEFAULT_PLUGINS: "true",
  CYXCODE_DISABLE_PROJECT_CONFIG: "true",
  CYXCODE_EXPERIMENTAL_DISABLE_FILEWATCHER: "true",
  CYXCODE_TEST_HOME: path.join(sandbox, "home"),
  XDG_DATA_HOME: path.join(sandbox, "share"),
  XDG_CACHE_HOME: path.join(sandbox, "cache"),
  XDG_CONFIG_HOME: path.join(sandbox, "config"),
  XDG_STATE_HOME: path.join(sandbox, "state"),
  CYXCODE_E2E_PROJECT_DIR: repoDir,
  CYXCODE_E2E_SESSION_TITLE: "E2E Session",
  CYXCODE_E2E_MESSAGE: "Seeded for UI e2e",
  CYXCODE_E2E_MODEL: "openai/gpt-3.5-turbo",
  CYXCODE_E2E_FAST_REPLY: "true",
  PLAYWRIGHT_TRACE: "off",
  PLAYWRIGHT_SCREENSHOT: "off",
  PLAYWRIGHT_VIDEO: "off",
  CYXCODE_CLIENT: "app",
  CYXCODE_STRICT_CONFIG_DEPS: "true",
...
const runnerEnv = {
  ...
  VITE_CYXCODE_SERVER_HOST: "127.0.0.1",
  VITE_CYXCODE_SERVER_PORT: String(serverPort),
