...
import { MessageNav } from "@cyxcode/ui/message-nav"
import { FileSSR } from "@cyxcode/ui/file-ssr"
          ...
          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | CyxCode</Title>
              </Show>
              <Meta name="description" content="CyxCode - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/code3hr/cyxcode"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
