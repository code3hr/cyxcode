...
const releaseId = process.env.CYXCODE_RELEASE
if (!releaseId) throw new Error("CYXCODE_RELEASE is required")

const version = process.env.CYXCODE_VERSION
if (!releaseId) throw new Error("CYXCODE_VERSION is required")
