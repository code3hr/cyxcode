export const dict = {
  ...
  "desktop.menu.help.documentation": "CyxCode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "CyxCode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
